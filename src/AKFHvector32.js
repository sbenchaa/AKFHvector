...
var AKFHvector32 = (function( window ) {
    "use strict";

    var sizeBuffer = 1024 * Float32Array.BYTES_PER_ELEMENT ;//, min allocation is 4096
...
/////////// Vector2
        ...
        function putVec2(ptr, x, y) {
            ...
            x = +x;
            y = +y;
            HEAP32f[ (ptr + 0 << 2) >> 2 ] = x; // shift must be 2 for 32bit 3 for 64bit
            HEAP32f[ (ptr + 1 << 2) >> 2 ] = y;
            return;
        }
        ...
        function copyVec2(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
        }
        ...
        function equalVec2(ptr1, ptr2) {
            ...
            var a = 0;
            var b = 0;
            a = (+HEAP32f[ (ptr1 + 0 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 0 << 2) >> 2 ]) | 0;
            b = (+HEAP32f[ (ptr1 + 1 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 1 << 2) >> 2 ]) | 0;
            return  ((a | 0) & (b | 0)) | 0;
        }
        ...
        function addVec2(ptr1, ptr2) {
            ptr1 = ptr1 | 0;
            ptr2 = ptr2 | 0;
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            return;
        }
        ...
        function addVec2Scalar(ptr1, v) {
            ptr1 = ptr1 | 0;
            v = +v;
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + v;
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + v;
            return;
        }
        ...
        function floorVec2(ptr1) {
            ...
            var x = 0.0;
            var y = 0.0;
            x = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            y = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            if (x > 0.0)
                HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +(~~x);
            else
                HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +(~~(x - +(~~(-1.0 - (x % 1.0))) - 1.0));
            if (y > 0.0)
                HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(~~y);
            else
                HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(~~(y - +(~~(-1.0 - (y % 1.0))) - 1.0));
            return;
        }
        ...
        function ceilVec2(ptr1) {
            ...
            y = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            if (x > 0.0)
                HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +(~~x) + 1.0;
            else
                HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +(~~(x - +(~~(-1.0 + (x % 1.0))) - 1.0));
            if (y > 0.0)
                HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(~~y) + 1.0;
            else
                HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(~~(y - +(~~(-1.0 + (y % 1.0))) - 1.0));
            return;
        }
        ...
        function negateVec2(ptr1) {
            ptr1 = ptr1 | 0;
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 0 << 2) >> 2 ]);
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 1 << 2) >> 2 ]);
            return;
        }
        ...
        function dotVec2(ptr1, ptr2) {
            ...
            var ab1 = 0.0;
            var ab2 = 0.0;
            ab0 = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            ab1 = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            return +(ab0 + ab1);
        }
        ...
        function crossVec2(ptr1, ptr2) {
            ...
            var bx = 0.0;
            var by = 0.0;
            ax = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            ay = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            bx = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            by = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
        ...
        function lerpVec2(ptr1, ptr2, v) {
            ...
            var bSa0 = 0.0;
            var bSa1 = 0.0;
            bSa0 = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            bSa1 = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];

            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + bSa0 * v;
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + bSa1 * v;
            return;
        }
        ...
        function distanceVec2(ptr1, ptr2) {
            ptr1 = ptr1 | 0;
            ptr2 = ptr2 | 0;
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
        ...
        function lengthManVec2(ptr) {
            ptr = ptr | 0;
            return +(+abs(+HEAP32f[ (ptr + 0 << 2) >> 2 ]) +
                    +abs(+HEAP32f[ (ptr + 1 << 2) >> 2 ]));
        }
        ...
        function copyVec3(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
        }
        ...
        function equalVec3(ptr1, ptr2) {
            ...
            a = (+HEAP32f[ (ptr1 + 0 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 0 << 2) >> 2 ]) | 0;
            b = (+HEAP32f[ (ptr1 + 1 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 1 << 2) >> 2 ]) | 0;
            c = (+HEAP32f[ (ptr1 + 2 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 2 << 2) >> 2 ]) | 0;
        ...
        function addVec3(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
            return;
        }
        ...
        function addVec3Scalar(ptr1, v) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + v;
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + v;
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + v;
            return;
        }
        ...
        function floorVec3(ptr1) {
            ...
            if (y > 0.0)
                ...
                HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(~~(y - +(~~(-1.0 - (y % 1.0))) - 1.0));
            if (z > 0.0)
                HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +(~~z);
            else
                HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +(~~(z - +(~~(-1.0 - (z % 1.0))) - 1.0));
            return;
        }
        ...
        function negateVec3(ptr1) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 0 << 2) >> 2 ]);
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 1 << 2) >> 2 ]);
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 2 << 2) >> 2 ]);
            return;
        }
        ...
        function dotVec3(ptr1, ptr2) {
            ...
            ab0 = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            ab1 = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            ab2 = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
            return +(ab0 + ab1 + ab2);
        }
        ...
        function crossVec3(ptr1, ptr2) {
            ...
            ax = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            ay = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            az = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ];
            bx = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ];
            by = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            bz = +HEAP32f[ (ptr2 + 2 << 2) >> 2 ];

            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +(ay * bz - az * by);
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +(az * bx - ax * bz);
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +(ax * by - ay * bx);
            return;
        }
        ...
        function lerpVec3(ptr1, ptr2, v) {
            ...
            bSa0 = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            bSa1 = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            bSa2 = +HEAP32f[ (ptr2 + 2 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 2 << 2) >> 2 ];

            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + bSa0 * v;
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + bSa1 * v;
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + bSa2 * v;
            return;
        }
        ...
        function distanceVec3(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 0 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 0 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 2 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 2 << 2) >> 2 ];
        ...
        function copyVec4(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = HEAP32f[ (ptr2 + 3 << 2) >> 2 ];
        }
        ...
        function equalVec4(ptr1, ptr2) {
            ...
            b = (+HEAP32f[ (ptr1 + 1 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 1 << 2) >> 2 ]) | 0;
            c = (+HEAP32f[ (ptr1 + 2 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 2 << 2) >> 2 ]) | 0;
            d = (+HEAP32f[ (ptr1 + 3 << 2) >> 2 ] == +HEAP32f[ (ptr2 + 3 << 2) >> 2 ]) | 0;
        ...
        function addVec4(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = HEAP32f[ (ptr1 + 3 << 2) >> 2 ] + HEAP32f[ (ptr2 + 3 << 2) >> 2 ];
            return;
        }
        ...
        function addVec4Scalar(ptr1, v) {
            ...
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + v;
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + v;
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 3 << 2) >> 2 ] + v;
            return;
        }
        ...
        function floorVec4(ptr1) {
            ...
            if (z > 0.0)
                ...
                HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +(~~(z - +(~~(-1.0 - (z % 1.0))) - 1.0));
            if (w > 0.0)
                HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = +(~~w);
            else
                HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = +(~~(w - +(~~(-1.0 - (w % 1.0))) - 1.0));
            return;
        }
        ...
        function negateVec4(ptr1) {
            ...
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 1 << 2) >> 2 ]);
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 2 << 2) >> 2 ]);
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = -(+HEAP32f[ (ptr1 + 3 << 2) >> 2 ]);
            return;
        }
        ...
        function dotVec4(ptr1, ptr2) {
            ...
            ab1 = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 1 << 2) >> 2 ];
            ab2 = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 2 << 2) >> 2 ];
            ab3 = +HEAP32f[ (ptr1 + 3 << 2) >> 2 ] * +HEAP32f[ (ptr2 + 3 << 2) >> 2 ];
        ...
        function lerpVec4(ptr1, ptr2, v) {
            ...
            bSa1 = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            bSa2 = +HEAP32f[ (ptr2 + 2 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 2 << 2) >> 2 ];
            bSa3 = +HEAP32f[ (ptr2 + 3 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 3 << 2) >> 2 ];

            HEAP32f[ (ptr1 + 0 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 0 << 2) >> 2 ] + bSa0 * v;
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 1 << 2) >> 2 ] + bSa1 * v;
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 2 << 2) >> 2 ] + bSa2 * v;
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = +HEAP32f[ (ptr1 + 3 << 2) >> 2 ] + bSa3 * v;
            return;
        }
        ...
        function distanceVec4(ptr1, ptr2) {
            ...
            HEAP32f[ (ptr1 + 1 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 1 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 1 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 2 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 2 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 2 << 2) >> 2 ];
            HEAP32f[ (ptr1 + 3 << 2) >> 2 ] = +HEAP32f[ (ptr2 + 3 << 2) >> 2 ] - +HEAP32f[ (ptr1 + 3 << 2) >> 2 ];
